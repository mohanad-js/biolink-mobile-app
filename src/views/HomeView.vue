...
<template>
  <main>
    ...
    <main class="home-screen">
      ...
      <section class="search-section w-100 px-6 pt-8">
        <div class="">
          ...
          <h2 class="heading-2 pt-2 pb-6">Let’s Find Your Doctor</h2>
      ...
      <section class="upcoming-slider-area pt-8">
        <div class="">
          <h3 class="heading-3 ps-6">Upcoming Shedule</h3>

          <div class="swiper doctor-appointment-slider custom pt-10">
            <div class="swiper-wrapper">
              <div class="d-flex justify-content-between align-items-center swiper-slide h-100">
                <div class="slider-desc d-flex flex-column justify-content-between align-items-start h-100">
                  <p class="position-relative slider-heading">
                    Professional Advisory: Protecting Health

                    <img src="@/assets/img/arrow.png" alt="" />
                  </p>

                  <p class="desc">Get special 10% discount this December</p>
                </div>

                <div class="h-100 doctor-img-area position-relative">
                  <img class="h-100 doctor-img" src="@/assets/img/upcoming-slider-img-1.png" alt="" />

                  <img src="@/assets/img/doctor_img_bg.png" class="background-img" alt="" />
                </div>
              </div>
              <div class="d-flex justify-content-between align-items-center swiper-slide h-100">
                <div class="slider-desc d-flex flex-column justify-content-between align-items-start h-100">
                  <p class="position-relative slider-heading">
                    Consult with specialists, Prevent you
                ...
                <div class="h-100 doctor-img-area position-relative">
                  <img class="h-100 doctor-img" src="@/assets/img/upcoming-slider-img-2.png" alt="" />
              ...
              <div class="d-flex justify-content-between align-items-center swiper-slide h-100">
                <div class="slider-desc d-flex flex-column justify-content-between align-items-start h-100">
                  <p class="position-relative slider-heading">
                    Specialist Guidance: Shield Your Health
                ...
                <div class="h-100 doctor-img-area position-relative">
                  <img class="h-100 doctor-img" src="@/assets/img/upcoming-slider-img-3.png" alt="" />
              ...
              <div class="d-flex justify-content-between align-items-center swiper-slide h-100">
                ...
                <div class="h-100 doctor-img-area position-relative">
                  <img class="h-100 doctor-img" src="@/assets/img/upcoming-slider-img-4.png" alt="" />
      ...
      <section class="px-6 pt-6 doctor-specialist-area">
        <div class="d-flex justify-content-between align-items-center">
          <h3>Doctor Speciality</h3>
          <button id="specialityModalOpenButton" class="view-all">
            View All
          </button>
        </div>

        <div class="swiper doctor-speciality-slider pt-5">
          <div class="swiper-wrapper">
            <div class="swiper-slide d-flex justify-content-start align-items-center gap-3 p-3">
              <div class="flex-center p-3 speciality-logo">
                <i class="ph-fill ph-eye"></i>
              </div>
              <div class="desc">
                <p class="fw-bold pb-1">Ophthalmologist</p>
                <p class="d-inline-flex justify-content-center align-items-center gap-2">
                  213 doctors <i class="ph ph-arrow-right fs-5"></i>
                </p>
              </div>
            </div>
            <div class="swiper-slide d-flex justify-content-start align-items-center gap-3 p-3">
              ...
              <div class="desc">
                <p class="fw-bold pb-1">Neurologist</p>
                <p class="d-inline-flex justify-content-center align-items-center gap-2">
                  210 doctors <i class="ph ph-arrow-right fs-5"></i>
                </p>
              </div>
            </div>
            <div class="swiper-slide d-flex justify-content-start align-items-center gap-3 p-3">
              <div class="flex-center p-3 speciality-logo">
                <i class="ph-fill ph-person-simple-bike"></i>
              </div>
              <div class="desc">
                <p class="fw-bold pb-1">Physicial</p>
                <p class="d-inline-flex justify-content-center align-items-center gap-2">
                  283 doctors <i class="ph ph-arrow-right fs-5"></i>
                </p>
              </div>
            </div>
            <div class="swiper-slide d-flex justify-content-start align-items-center gap-3 p-3">
        ...
        <div class="d-flex flex-column gap-4 pt-4">
          <div class="w-100 top-doctor-item p-4">
            <div class="d-flex justify-content-between align-items-start gap-4">
              <div class="d-flex justify-content-start align-items-start gap-4">
                <div class="doctor-img flex-center">
                  <img src="@/assets/img/top-doctor-1.png" class="h-100" alt="" />
            ...
            <div class="d-flex justify-content-between align-items-center pt-4">
              <a href="./doctor-profile.html" class="appointment-link d-block p1-color">Appointment</a>
          ...
          <div class="w-100 top-doctor-item p-4">
            <div class="d-flex justify-content-between align-items-start gap-4">
              <div class="d-flex justify-content-start align-items-start gap-4">
                <div class="doctor-img flex-center">
                  <img src="@/assets/img/top-doctor-2.png" class="h-100" alt="" />
                  <img src="@/assets/img/active.png" class="active" alt="" />
                </div>
                <div class="">
          ...
          <div class="w-100 top-doctor-item p-4">
            <div class="d-flex justify-content-between align-items-start gap-2">
              <div class="d-flex justify-content-start align-items-start gap-4">
                <div class="doctor-img flex-center">
                  <img src="@/assets/img/top-doctor-3.png" class="h-100" alt="" />
                  <img src="@/assets/img/active.png" class="active" alt="" />
                </div>
                <div class="">
    ...
    <div class="position-fixed top-0 start-0 bottom-0 end-0 notificationModal overflow-auto fullPageModalClose">
      ...
      <div class="notification-area pt-5 px-6 d-flex flex-column gap-6 pb-8">
          ...
          <div class="d-flex flex-column gap-4">
            ...
            <div class="notification-item active d-flex justify-content-start align-items-start gap-5">
              ...
              <div class="d-flex justify-content-start align-items-start flex-column">
                ...
                <a href="" class="primary-button flex-center gap-2">New <i class="ph ph-arrow-right"></i></a>
              </div>
            </div>
          </div>
        </div>
        <div class="">
          ...
          <div class="d-flex flex-column gap-4">
            <div class="notification-item d-flex justify-content-start align-items-center gap-5">
              <div class="flex-center p-4 icon">
                <i class="ph-fill ph-calendar-check"></i>
              </div>
              <div class="">
    ...
    <div class="position-fixed top-0 start-0 bottom-0 end-0 favouriteModal overflow-auto fullPageModalClose">
      <div class="px-6 pt-8 notification-top-area">
        <div class="d-flex justify-content-start align-items-center gap-4 py-3">
          <button class="back-button flex-center" id="favoriteModalCloseButton">
            <i class="ph ph-caret-left"></i>
          </button>
          <h2>My Favourite Doctor</h2>
        </div>
      </div>
    ...
    <div class="px-6 filter-area position-fixed top-0 start-0 bottom-0 end-0 pb-12 filterModal fullPageModalClose">
      ...
      <div class="d-flex justify-content-start align-items-start flex-column gap-8 filter-category-area pt-8">
        <div class="sort-options w-100">
          <h6 class="pb-5">Sort Option</h6>

          <div class="p-5 options-box w-100 d-flex flex-column justify-content-start align-items-start gap-4">
            <div class="option-item w-100">
              <label class="custom-radio alt-size d-flex justify-content-between align-items-center">
        ...
        <div class="schedule-section w-100">
          ...
          <div class="schedule-area">
            <div class="schedule-day d-flex justify-content-start align-items-center gap-3 overflow-auto">
            ...
            <div class="schedule-time mt-3 d-flex justify-content-start align-items-center gap-3 overflow-auto">
        ...
        <div class="row doctor-speciality g-4">
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              ...
              <a href="#" class="d-inline-flex align-items-center gap-1">120 doctors <i
          ...
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              ...
              <a href="#" class="d-inline-flex align-items-center gap-1">95 doctors <i
                  class="ph ph-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              ...
              <a href="#" class="d-inline-flex align-items-center gap-1">48 doctors <i
                  class="ph ph-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              ...
              <a href="#" class="d-inline-flex align-items-center gap-1">65 doctors <i
                  class="ph ph-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              ...
              <a href="#" class="d-inline-flex align-items-center gap-1">175 doctors <i
                  class="ph ph-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              ...
              <a href="#" class="d-inline-flex align-items-center gap-1">85 doctors <i
                  class="ph ph-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              ...
              <a href="#" class="d-inline-flex align-items-center gap-1">75 doctors <i
                  class="ph ph-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              ...
              <a href="#" class="d-inline-flex align-items-center gap-1">125 doctors <i
                  class="ph ph-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              ...
              <a href="#" class="d-inline-flex align-items-center gap-1">110 doctors <i
                  class="ph ph-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-6">
          ...
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              ...
              <a href="#" class="d-inline-flex align-items-center gap-1">135 doctors <i
                  class="ph ph-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              <img src="@/assets/img/docton-speciality-icon-2.png" alt="" />
              <p class="title">Dermatologist</p>
              <a href="#" class="d-inline-flex align-items-center gap-1">170 doctors <i
                  class="ph ph-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              <img src="@/assets/img/docton-speciality-icon-3.png" alt="" />
              <p class="title">Pediatrician</p>
              <a href="#" class="d-inline-flex align-items-center gap-1">180 doctors <i
                  class="ph ph-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              <img src="@/assets/img/docton-speciality-icon-4.png" alt="" />
              <p class="title">Gynecologist</p>
              <a href="#" class="d-inline-flex align-items-center gap-1">200 doctors <i
                  class="ph ph-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              <img src="@/assets/img/docton-speciality-icon-5.png" alt="" />
              <p class="title">Physician</p>
              <a href="#" class="d-inline-flex align-items-center gap-1">140 doctors <i
                  class="ph ph-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-6">
            <div class="item flex-center flex-column px-2 py-4">
              <img src="@/assets/img/docton-speciality-icon-6.png" alt="" />
              <p class="title">Surgeon</p>
              <a href="#" class="d-inline-flex align-items-center gap-1">20 doctors <i
                  class="ph ph-arrow-right"></i></a>
            </div>
          </div>
        </div>
    ...
    <div class="topDoctorModal position-fixed top-0 start-0 bottom-0 end-0 fullPageModalClose overflow-auto">
      <div class="px-6 pt-8 notification-top-area">
        <div class="d-flex justify-content-start align-items-center gap-4 py-3">
          <button class="back-button flex-center" id="topDoctorModalCloseButton">
            <i class="ph ph-caret-left"></i>
          </button>
          <h2>Top Doctor</h2>
        </div>
      ...
      <div class="px-6 search-category-area">
        <div class="overflow-hidden">
          <ul class="d-flex justify-content-start search-category align-items-center gap-3 pt-5 overflow-auto">
            <li class="category-item active">All</li>
            <li class="category-item">
              <a href="./top-doctor-search-loading.html" class="p1-color">General</a>
            </li>
            <li class="category-item">
              <a href="./top-doctor-search-not-found.html" class="p1-color">Dentist</a>
            </li>
